...
from src.tac.core.wavenet_vocoder.synthesize import wavenet_synthesize
...
def run():
  ...
  from src.tac.training.WavTraining import get_log_dir
  from src.tac.core.wavenet_vocoder.train import get_save_dir
