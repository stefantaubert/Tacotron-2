...
from src.tac.preprocessing.text.TextProcessor import get_txt_dir
from src.tac.preprocessing.audio.WavProcessor import get_mel_dir, get_lin_dir, get_wav_dir
from src.tac.preprocessing.Preprocessor import load_meta, get_train_txt
